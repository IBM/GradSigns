...
class MaskedDense(Layer):
    ...
    def build(self, input_shape):
        ...
        self.kernel_mask = tf.Variable(initial_value=self.kernel_mask_val, trainable=False)
    ...
    def call(self, inputs):
        if self.Masked == True:
            output = K.dot(inputs, self.kernel*self.kernel_mask)
        else:
...
class MaskedConv2D(MaskedConv):
    ...
    def __init__(self, filters,
        ...
        super(MaskedConv2D, self).__init__(
            ...
            Masked=Masked,
            kernel_mask_val=kernel_mask_val,
            **kwargs)
